...
Dict{Symbol,Any}(
    ...
    # -----------------------------------------------------------------
    :execution_mode => :prepare_only,      # :prepare_only, :submit_and_wait
    :points_per_job => 200,
    ...
    :slurm_partition => "",               # e.g. "compute"
    :slurm_account => "",                 # e.g. "my_account"
    :slurm_qos => "",
    :slurm_constraint => "",
    :slurm_reservation => "",
    ...
    :calibration_partition => "test",     # set "" to use :slurm_partition
    :calibration_account => "",           # set if your test partition requires account
