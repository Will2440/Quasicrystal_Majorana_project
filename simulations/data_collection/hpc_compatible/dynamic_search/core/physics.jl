...
export np_create_bdg_hamiltonian,
       build_operators_block_basis,
       np_calc_specloc_signature_sparse_ldlt,
       np_calc_specloc_low_lying_shift_invert,
       evaluate_specloc_point

# ---------------------------------------------------------------------
# NOTE:
# The spectral-localiser kernels below are copied from serial_batch/solvers.jl
# to keep the physics computation unchanged.
# ---------------------------------------------------------------------
...
function build_operators_block_basis(
    N::Int
)
    dim = 2 * N
